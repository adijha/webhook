			...
			if (!err) {
				...
				switch (topic) {
					...
					case 'orders/create':
						...
						if (
							data.data['orders/create customer'] === true &&
							data.data['orders/create admin'] === true
						) {
								...
								data.template.forEach((element) => {
									if (element.topic === topic) {
										if (element.customer) {
											...
											console.log(
												'orders/create customer message template not found'
											);
										}
									} else {
										console.log(
								...
								data.template.forEach((element) => {
									if (element.topic === topic) {
										if (element.admin) {
											...
											console.log(
												'orders/create admin message template not found'
											);
										}
									} else {
										console.log(
								...
								data.template.forEach((element) => {
									if (element.topic === topic) {
										if (element.customer) {
											...
											console.log(
												'orders/fulfille customer message template not found'
											);
										}
									} else {
										console.log(
								...
								data.template.forEach((element) => {
									if (element.topic === topic) {
										if (element.admin) {
											...
											console.log(
												'orders/fulfillment admin message template not found'
											);
										}
									} else {
										console.log(
											'orders/fulfilled admin message template not found'
										);
									}
								});
							}
								...
								data.template.forEach((element) => {
									if (element.topic === topic) {
										if (element.customer) {
											...
											console.log(
												'orders/cancelled customer message template not found'
											);
										}
									} else {
										console.log(
								...
								data.template.forEach((element) => {
									if (element.topic === topic) {
										if (element.admin) {
											...
											console.log(
												'orders/cancelled admin message template not found'
											);
										}
									} else {
										console.log(
...
const sndSms = async (phone, message, senderID, shop) => {
	...
	if (phone.includes('e') || phone.includes('-')) {
		console.log(
			"phone no. includes '-' or 'e', that's why we can't send message"
		);
	}
	...
	if (phone.length >= 10) {
		...
		console.log(
			" can't send sms because, phone number is < 10 digits i.e : ",
			phone
		);
	}
